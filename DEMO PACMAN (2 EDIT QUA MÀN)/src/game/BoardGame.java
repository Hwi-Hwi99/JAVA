...
public class BoardGame extends JPanel implements ActionListener {
    ...
    private final int MAX_GHOSTS = 12; // = 12
    private final int PACMAN_SPEED = 8;

    private int pacAnimCount = PAC_ANIM_DELAY;
    private int pacAnimDir = 1;
    private int pacmanAnimPos = 0;
    private int N_GHOSTS = 4; // = 6
    private int pacsLeft, score, newscore;

    private boolean scoreSet = false;

    private String saveDataPath;
    private String fileName = "Data";
    private String DATA_FILE_PATH = "C:\\Data\\Data.txt";
    ...
    private void setScore() {
        ...
        String playerName = JOptionPane.showInputDialog("Bạn đã được: " + score + " Strawberry. " + " Mời nhập tên:  ");
        if (playerName == null || playerName.trim().isEmpty()) {
            playerName = "Noname";
        }
        this.toBack();
        try {
            FileWriter fileWriter = new FileWriter(DATA_FILE_PATH, true); // Mở file để ghi dữ liệu, tham số true để ghi tiếp vào file
            BufferedWriter bufferedWriter = new BufferedWriter(fileWriter);
            Date currentDate = new Date();
            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            String dateTimeString = dateFormat.format(currentDate);
            bufferedWriter.write(score + " Strawberry" + " - Tên: " + playerName + " - Ngày chơi: " + dateTimeString); // Ghi tên người chơi và số điểm vào file
    ...
    private void nextLevel() {
        ...
        // số mạng trên 0
        if (pacsLeft > 0) {
            if (N_GHOSTS < MAX_GHOSTS && currentSpeed < maxSpeed) {
                N_GHOSTS = N_GHOSTS + 2;
                currentSpeed++;
                initLevel();
            }
    ...
    private void loadImages() {
        dotColor = new ImageIcon("Assets/thucan1.png").getImage();
        ghost = new ImageIcon("Assets/ghots.png").getImage();
        pacman1 = new ImageIcon("Assets/pacmanup.png").getImage();
        pacman2up = new ImageIcon("Assets/pmup.png").getImage();
        pacman3up = new ImageIcon("Assets/pmup.png").getImage();
        pacman4up = new ImageIcon("Assets/pmup.png").getImage();
        pacman2down = new ImageIcon("Assets/pmdown.png").getImage();
        pacman3down = new ImageIcon("Assets/pmdown.png").getImage();
        pacman4down = new ImageIcon("Assets/pmdown.png").getImage();
        pacman2left = new ImageIcon("Assets/pcleft.png").getImage();
        pacman3left = new ImageIcon("Assets/pcleft.png").getImage();
        pacman4left = new ImageIcon("Assets/pcleft.png").getImage();
        pacman2right = new ImageIcon("Assets/pmright.png").getImage();
        pacman3right = new ImageIcon("Assets/pmright.png").getImage();
        pacman4right = new ImageIcon("Assets/pmright.png").getImage();
